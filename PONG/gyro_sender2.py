...
bus.write_byte_data(0x1d,0x31,0x08)
time.sleep(0.5)
...
def read_sensor_data():
	...
	data0 = bus.read_byte_data(0x1d,0x32)
	data1 = bus.read_byte_data(0x1d, 0x33)
	#convert data to 10 base
	xAccl = ((data1 & 0x03)*256) + data0
	if xAccl > 551 :
		xAccl -= 1024
	#read data for the Y axis
	data0 = bus.read_byte_data(0x1d, 0x34)
	data1 = bus.read_byte_data(0x1d, 0x35)
	...
	data0 = bus.read_byte_data(0x1d, 0x36)
	data1 = bus.read_byte_data(0x1d, 0x37)
